...
@Singleton
class TomlServiceImpl @Inject constructor(
    private val toml: Toml,
    @ApplicationContext private val context: Context,
) : TomlService {
    override suspend fun readParametersTomlFile(): NamadaExplorerParameters {
        toml.read(context.resources.openRawResource(R.raw.parameters))
        return NamadaExplorerParameters(
            parameters = NamadaExplorerParameters.Parameters(
            ...
            posParams = NamadaExplorerParameters.PosParams(
            ...
            govParams = NamadaExplorerParameters.GovParams(
            ...
            minimumGasPrice = NamadaExplorerParameters.MinimumGasPriceParams(
